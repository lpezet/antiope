...
/**
 * A hook allowing clients to customize {@link AntiopeError RetrofitError}.
 *
 * @author Sam Beran sberan@gmail.com
 */
public interface ErrorHandler {
  /**
   * Return a custom exception to be thrown for a {@link AntiopeError}. It is recommended that you
   ...
   * </pre>
   *
   * @param cause the original {@link AntiopeError} exception
   ...
   */
  Throwable handleError(AntiopeError cause);

  /** An {@link ErrorHandler} which returns the original error. */
  ErrorHandler DEFAULT = new ErrorHandler() {
    @Override public Throwable handleError(AntiopeError cause) {
      return cause;
    }
  };
}
