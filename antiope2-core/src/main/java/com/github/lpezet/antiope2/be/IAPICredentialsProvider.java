...
public interface IAPICredentialsProvider {
	...
	/**
     * Returns ITSGCredentials which the caller can use to authorize a TSG request.
     * Each implementation of TSGCredentialsProvider can chose its own strategy for
     ...
     *
     * @return TSGCredentials which the caller can use to authorize an TSG request.
     */
